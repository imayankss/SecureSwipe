...
INVENTORY = {
    ...
    "Dataset curation command": PROJECT_ROOT / "scripts/curate_dataset.py",
    "Development training command": PROJECT_ROOT / "scripts/run_development_training.py",
    ...
    return [
        ...
        CommandGate(
            ...
            (
                ...
                "scripts/run_development_training.py",
        ...
        CommandGate(
            "Linux API dependency vulnerabilities",
            (
                python,
                "-m",
                "pip_audit",
                "-r",
                "requirements/api-linux.lock",
                "--disable-pip",
                "--progress-spinner",
                "off",
            ),
        ...
        CommandGate(
            "Linux quality dependency vulnerabilities",
            (
                python,
                "-m",
                "pip_audit",
                "-r",
                "requirements/quality-linux.lock",
                "--disable-pip",
                "--progress-spinner",
                "off",
            ),
