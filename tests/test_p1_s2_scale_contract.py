...
def test_test_dsn_guard_requires_loopback_and_test_database() -> None:
    ...
    with pytest.raises(ScaleConfigurationError, match="loopback"):
        validate_test_dsn("postgresql://user:secret@db.example.invalid/example_test")  # trufflehog:ignore — intentionally invalid unreachable test fixture; no real credential
