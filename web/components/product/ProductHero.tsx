...
export function ProductHero() {
  return (
    <section
      ...
      className="scroll-mt-20 py-16 focus:outline-none sm:py-24 lg:py-28"
    >
      <div className="grid gap-10 lg:grid-cols-[minmax(0,1.12fr)_minmax(19rem,0.88fr)] lg:items-center lg:gap-14">
        <div className="max-w-3xl">
          <p className="ss-eyebrow">SecureSwipe · AI Risk Manager</p>
          <h1
            id="product-heading"
            className="mt-4 max-w-4xl text-4xl leading-[1.04] tracking-[-0.045em] sm:text-6xl"
          >
          ...
          <p className="mt-4 max-w-2xl text-sm leading-6 text-slate-400">
            SecureSwipe routes results only to <strong className="font-medium text-white">human review</strong> or
            marks them <strong className="font-medium text-white">below review threshold</strong>.
        ...
        <aside
          className="command-panel p-6 sm:p-8"
        ...
        >
          ...
          <p className="ss-number mt-4 break-words text-5xl font-semibold leading-none text-white">
          ...
          <p className="mt-4 border-t border-white/[0.08] pt-4 text-[11px] leading-5 text-slate-500">
      ...
      <p className="mt-10 max-w-2xl border-l border-white/10 pl-3 text-xs leading-5 text-slate-500">
